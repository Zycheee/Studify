...
const Login = () => {
  ...
  const loginClick = async () => {
    ...
    setValid({ valid: false }); // clear previous error
    ...
    <div className="flex flex-col justify-center items-center min-h-screen font-sans bg-[#ffffff] animate-fadeIn">
      ...
      <div className="flex flex-col w-full justify-center md:flex-row items-center p-8 gap-30">
        <img
          src={Design}
          alt="design"
          className="rounded-[20px] transition-all duration-500 ease-in-out w-100 hidden md:block md:w-120 xl:w-200"
        />
        <div className="flex-col flex md:w-50 lg:w-100">
          <span className="text-[30px] font-semibold text-gray-700">Hello!</span>
          <span className="text-[50px] mb-2 font-bold text-gray-700">Welcome back!</span>
            ...
            <div className="flex justify-center font-regular">
              <label>
                ...
                <span
                  ...
                  className="text-blue-600 font-semibold transition-all ease-in-out delay-75 cursor-pointer hover:underline"
                >
                  Register here
                </span>
              </label>
